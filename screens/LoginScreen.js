import { View, Dimensions,Text, TouchableOpacity, Image, TextInput } from 'react-native'
...
export default function LoginScreen() {
  ...
  return (
    <View className="flex-1 bg-white" style={{flex:1,backgroundColor:"rgba(31, 144, 237, 0.872)"}}>
      <SafeAreaView >
        ...
        <View  style={{justifyContent:"center",alignContent:"center",alignItems:"center"}}className="flex-row justify-center">
          ...
          style={{width: 230, height: height/4}} />
        </View>
        
        
      </SafeAreaView>
      <View 
        style={{flex:1,borderTopLeftRadius: 50, borderTopRightRadius: 50, backgroundColor:"white",marginTop:30,paddingTop:40,paddingLeft:10}} 
        className="flex-1 bg-white px-8 pt-8">
          <View className="form space-y-2">
            ...
            />
            <Text 
            style={{marginLeft:40,marginBottom:10,fontWeight:"bold",fontSize:16,marginTop:25}}
            ...
            <TouchableOpacity className="flex items-end">
              <Text 
            style={{marginLeft:40,marginBottom:10,fontSize:16,marginTop:7,color:'gray'}}
             ...
             <TouchableOpacity
                    ...
                    className=" bg-yellow-400 mx-7 rounded-xl">
                        <Text 
                            ...
                            style={{fontWeight:'bold', textAlign:'center', fontColor:'white',fontSize:16}}
                        >
                            Sign In
                        </Text>
                </TouchableOpacity>
          ...
          <View style={{display:'flex',flexDirection:'row',justifyContent:'center',marginTop:40}}>
              ...
              <TouchableOpacity onPress={()=> navigation.navigate('SignUp')}>
                  ...
                  style={{fontColor:"white",fontWeight:"bold"}}
                  > Sign Up</Text>
              </TouchableOpacity>
          </View>
